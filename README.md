...
binding for unit test execution is **log4j2**.
...
````groovy
dependencies {
  testImplementation group: 'org.pfsw', name: 'pf-julea-log4j2', version: '2.1.1'
  testImplementation group: 'org.apache.logging.log4j', name: 'log4j-core', version: '2.26.1'
