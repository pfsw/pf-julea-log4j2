 ...
 */
public interface Junit4Log4j2Asserter extends JunitLogAsserter
{
  /**
   ...
   * @return A new tracker instance listening on the specified loggers. 
   */
  default Junit4Log4j2Tracker trackLogger(Class<?>... classes)
  {
    return Junit4Log4j2Tracker.track(classes);
  }
